...
_If you're a Go person and wondering why we don't just append the `vendor` directory to `GOPATH` and can explain to us how to make Git and Go and submodules and the presence (or absence...) of `.git` directories in the vendor-ed package all play nicely together please please please [drop us a line](https://github.com/whosonfirst/go-whosonfirst-pip/issues). It the meantime this is the devil we know..._
